...
@section('title', 'Site Settings - RisingCare')
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <textarea name="settings[meta_keywords]" rows="3" placeholder="kesehatan, home care, dokter, perawat"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500">{{ old('settings.meta_keywords', $settings['meta_keywords'] ?? '') }}</textarea>
                    ...
                    <div>
                        ...
                        <textarea name="settings[meta_description]" rows="3" placeholder="Deskripsi singkat situs untuk mesin pencari"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500">{{ old('settings.meta_description', $settings['meta_description'] ?? '') }}</textarea>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" name="settings[site_name]" 
                        value="{{ old('settings.site_name', $settings['site_name'] ?? 'RisingCare') }}"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="settings[site_tagline]" 
                        value="{{ old('settings.site_tagline', $settings['site_tagline'] ?? 'Layanan Kesehatan Terpercaya') }}"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500">
                </div>
                ...
                <div>
                    ...
                    <textarea name="settings[site_description]" rows="3"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500">{{ old('settings.site_description', $settings['site_description'] ?? '') }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea name="settings[contact_address]" rows="2"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500">{{ old('settings.contact_address', $settings['contact_address'] ?? '') }}</textarea>
                </div>
            </div>
        </div>
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" name="settings[stat_happy_patients]" 
                        value="{{ old('settings.stat_happy_patients', $settings['stat_happy_patients'] ?? '1000') }}"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="settings[stat_expert_doctors]" 
                        value="{{ old('settings.stat_expert_doctors', $settings['stat_expert_doctors'] ?? '35') }}"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="settings[stat_years_experience]" 
                        value="{{ old('settings.stat_years_experience', $settings['stat_years_experience'] ?? '15') }}"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="settings[stat_clinic_rooms]" 
                        value="{{ old('settings.stat_clinic_rooms', $settings['stat_clinic_rooms'] ?? '5') }}"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500">
                </div>
            </div>
        </div>
