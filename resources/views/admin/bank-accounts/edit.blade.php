...
@section('title', 'Edit Rekening Bank - RisingCare')
...
<div class="mb-6">
    <div class="flex items-center gap-4">
        ...
        <div>
            ...
            <p class="text-gray-600">Perbarui informasi rekening bank</p>
        </div>
    </div>
</div>
...
<div class="bg-white rounded-xl shadow-sm p-8 max-w-2xl">
    <form action="{{ route('admin.bank-accounts.update', $bankAccount) }}" method="POST">
        ...
        <div class="mb-6">
            ...
            <input type="number" name="display_order" value="{{ old('display_order', $bankAccount->display_order) }}" min="0"
