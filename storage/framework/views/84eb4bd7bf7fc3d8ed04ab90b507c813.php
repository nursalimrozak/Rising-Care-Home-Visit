...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Dashboard Petugas - RisingCare'); ?></title>
...
<body class="bg-gray-100 font-sans">
        ...
        <aside class="w-64 bg-gray-800 text-white flex-shrink-0 hidden md:flex flex-col">
            ...
            <div class="flex-1 overflow-y-auto py-4">
                <nav class="space-y-1 px-2">
                    <a href="<?php echo e(route('petugas.dashboard')); ?>" class="group flex items-center px-2 py-2 text-base font-medium rounded-md <?php echo e(request()->routeIs('petugas.dashboard') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white'); ?>">
                    ...
                    <a href="<?php echo e(route('petugas.bookings')); ?>" class="group flex items-center px-2 py-2 text-base font-medium rounded-md <?php echo e(request()->routeIs('petugas.bookings*') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white'); ?>">
                        <i class="fas fa-calendar-check mr-3 text-lg w-6 text-center"></i>
                        Booking Saya
                    </a>
                    <a href="<?php echo e(route('petugas.bookings')); ?>?filter=today" class="group flex items-center px-2 py-2 text-base font-medium rounded-md text-gray-300 hover:bg-gray-700 hover:text-white">
                        <i class="fas fa-clock mr-3 text-lg w-6 text-center"></i>
                        Jadwal Hari Ini
                    </a>
                    <a href="<?php echo e(route('petugas.commissions')); ?>" class="group flex items-center px-2 py-2 text-base font-medium rounded-md <?php echo e(request()->routeIs('petugas.commissions') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white'); ?>">
                    ...
                    <a href="<?php echo e(route('petugas.profile')); ?>" class="group flex items-center px-2 py-2 text-base font-medium rounded-md <?php echo e(request()->routeIs('petugas.profile') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white'); ?>">
    ...
    <?php if(!Auth::user()->payoutDetail && !request()->routeIs('petugas.profile')): ?>
            ...
            <div class="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
                <div x-show="show" 
                            ...
                            <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                ...
                                <div class="mt-2">
                                    <p class="text-sm text-gray-500">
                                        Halo <?php echo e(Auth::user()->name); ?>, kami mendeteksi bahwa Anda belum melengkapi data rekening atau e-wallet. 
                    ...
                    <div class="bg-gray-50 px-6 py-4 flex flex-row-reverse gap-3">
                        <a href="<?php echo e(route('petugas.profile')); ?>" class="inline-flex w-full justify-center rounded-xl bg-teal-600 px-5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-teal-500 sm:w-auto transition-colors">
                            Lengkapi Sekarang
                        </a>
...
<?php /**PATH D:\Project\laragon\www\risingcare\resources\views/layouts/petugas.blade.php ENDPATH**/ ?>