...
<?php $__env->startSection('title', 'Testimonials - RisingCare'); ?>
                ...
                <tr class="hover:bg-gray-50">
                    <td class="px-6 py-4">
                        <div class="flex items-center">
                            <?php if($item->customer_avatar): ?>
                                <img src="<?php echo e(asset('storage/' . $item->customer_avatar)); ?>" alt="<?php echo e($item->customer_name); ?>" class="w-10 h-10 rounded-full object-cover mr-3">
                            <?php else: ?>
                                <div class="w-10 h-10 rounded-full bg-teal-100 flex items-center justify-center mr-3">
                                    <i class="fas fa-user text-teal-600"></i>
                                </div>
                            <?php endif; ?>
                            <div class="font-medium text-gray-900"><?php echo e($item->customer_name); ?></div>
                        </div>
                    </td>
                    <td class="px-6 py-4">
                        <div class="flex text-yellow-400">
                            <?php for($i = 1; $i <= 5; $i++): ?>
                                <i class="fas fa-star<?php echo e($i <= $item->rating ? '' : ' text-gray-300'); ?>"></i>
                            <?php endfor; ?>
                        </div>
                    </td>
                    <td class="px-6 py-4">
                        <div class="text-sm text-gray-600"><?php echo e(Str::limit($item->comment, 50)); ?></div>
                    </td>
                    <td class="px-6 py-4">
                        <span class="text-sm text-gray-600"><?php echo e($item->service_name ?? '-'); ?></span>
                    </td>
                    <td class="px-6 py-4">
                    ...
                    <td class="px-6 py-4 text-sm font-medium">
                        <div class="flex space-x-3">
                            ...
                            <form id="deleteForm<?php echo e($item->id); ?>" action="<?php echo e(route('admin.landing.testimonials.destroy', $item)); ?>" method="POST" class="inline">
                                <?php echo csrf_field(); ?>
...
<div id="createModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50">
    <div class="bg-white rounded-xl shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <form id="createForm" method="POST" action="<?php echo e(route('admin.landing.testimonials.store')); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Project\laragon\www\risingcare\resources\views/admin/landing/testimonials/index.blade.php ENDPATH**/ ?>