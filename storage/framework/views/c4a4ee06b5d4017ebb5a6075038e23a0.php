...
<?php $__env->startSection('title', 'Manajemen Membership - RisingCare'); ?>
    ...
    <table class="w-full text-left">
        ...
        <tbody class="divide-y divide-gray-100">
            ...
            <tr class="hover:bg-gray-50">
                <td class="px-6 py-4 font-medium text-gray-900"><?php echo e($membership->name); ?></td>
                <td class="px-6 py-4 text-gray-600"><?php echo e($membership->description ?? '-'); ?></td>
                <td class="px-6 py-4">
                    <span class="px-2 py-1 text-xs font-medium bg-green-100 text-green-800 rounded-full">
                        <?php echo e($membership->discount_percentage); ?>%
                    </span>
                </td>
                <td class="px-6 py-4">
                    <span class="bg-blue-100 text-blue-800 text-xs font-medium px-2.5 py-0.5 rounded-full">
                        <?php echo e($membership->users_count); ?> User
                    </span>
                </td>
                <td class="px-6 py-4 text-sm font-medium">
                    <div class="flex space-x-3">
                        <button onclick="editMembership(<?php echo e($membership->id); ?>, '<?php echo e(addslashes($membership->name)); ?>', '<?php echo e(addslashes($membership->description)); ?>', <?php echo e($membership->discount_percentage); ?>)" class="text-blue-600 hover:text-blue-900">
                            <i class="fas fa-edit"></i>
                        </button>
                        <form id="deleteForm<?php echo e($membership->id); ?>" action="<?php echo e(route('admin.memberships.destroy', $membership)); ?>" method="POST" class="inline">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('DELETE'); ?>
                            <button type="button" onclick="openDeleteModal('deleteForm<?php echo e($membership->id); ?>', '<?php echo e(addslashes($membership->name)); ?>')" class="text-red-600 hover:text-red-900"><i class="fas fa-trash"></i></button>
                        </form>
                    </div>
                </td>
            </tr>
...
<div id="createModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 hidden overflow-y-auto h-full w-full z-50">
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
        <div class="mt-3">
            ...
            <form action="<?php echo e(route('admin.memberships.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="mb-4">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Project\laragon\www\risingcare\resources\views/admin/memberships/index.blade.php ENDPATH**/ ?>