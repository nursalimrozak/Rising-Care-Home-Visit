...
<?php $__env->startSection('title', 'Manajemen Booking - RisingCare'); ?>
...
<div x-data="{ activeTab: 'regular' }">
    ...
    <div x-show="activeTab === 'regular'" class="bg-white rounded-xl shadow-sm overflow-hidden">
        <?php echo $__env->make('admin.bookings.partials.booking-table', ['bookings' => $regularBookings], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>

    <!-- Eksekutif Table -->
    <div x-show="activeTab === 'eksekutif'" class="bg-white rounded-xl shadow-sm overflow-hidden" style="display: none;">
        <?php echo $__env->make('admin.bookings.partials.booking-table', ['bookings' => $eksekutifBookings], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>

    <!-- VIP Table -->
    <div x-show="activeTab === 'vip'" class="bg-white rounded-xl shadow-sm overflow-hidden" style="display: none;">
        <?php echo $__env->make('admin.bookings.partials.booking-table', ['bookings' => $vipBookings], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>

    <!-- Premium Table -->
    <div x-show="activeTab === 'premium'" class="bg-white rounded-xl shadow-sm overflow-hidden" style="display: none;">
        <?php echo $__env->make('admin.bookings.partials.booking-table', ['bookings' => $premiumBookings], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Project\laragon\www\risingcare\resources\views/admin/bookings/index.blade.php ENDPATH**/ ?>