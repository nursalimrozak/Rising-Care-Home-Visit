...
<?php $__env->startSection('title', 'Reviews - RisingCare'); ?>
    ...
    <form action="<?php echo e(route('admin.settings.update')); ?>" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <input type="text" name="settings[landing_reviews_title]" value="<?php echo e($sectionTitle ?? 'Apa Kata Mereka'); ?>" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500">
            </div>
            <div>
                <label class="block text-gray-700 font-medium mb-2">Section Subtitle</label>
                <input type="text" name="settings[landing_reviews_subtitle]" value="<?php echo e($sectionSubtitle ?? 'Testimoni dari pasien yang telah menggunakan layanan kami'); ?>" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500">
            </div>
        </div>
        ...
        <table class="w-full text-left">
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50">
                    <td class="px-6 py-4">
                        <div class="font-medium text-gray-900"><?php echo e($review->customer->name); ?></div>
                        <div class="text-sm text-gray-500"><?php echo e($review->customer->email); ?></div>
                    </td>
                    <td class="px-6 py-4">
                        <div class="text-sm text-gray-900"><?php echo e($review->booking->service->name ?? '-'); ?></div>
                    </td>
                    <td class="px-6 py-4">
                        ...
                        <span class="text-sm text-gray-600"><?php echo e($review->rating); ?>/5</span>
                    </td>
                    <td class="px-6 py-4">
                        <p class="text-sm text-gray-600"><?php echo e(Str::limit($review->comment, 50)); ?></p>
                    </td>
                    <td class="px-6 py-4">
                        <button 
                            onclick="toggleLanding(<?php echo e($review->id); ?>, this)"
                            class="toggle-btn px-3 py-1 rounded-full text-xs font-medium <?php echo e($review->show_on_landing ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                            <?php echo e($review->show_on_landing ? 'Ditampilkan' : 'Disembunyikan'); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Project\laragon\www\risingcare\resources\views/admin/reviews/index.blade.php ENDPATH**/ ?>