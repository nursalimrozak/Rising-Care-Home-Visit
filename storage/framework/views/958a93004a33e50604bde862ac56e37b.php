    ...
    <table class="w-full text-left">
        ...
        <tbody class="divide-y divide-gray-100">
            ...
            <tr class="hover:bg-gray-50">
                ...
                <td class="px-6 py-4">
                    <div class="font-medium text-gray-900"><?php echo e($booking->customer?->name ?? 'N/A'); ?></div>
                    <div class="text-xs text-gray-500"><?php echo e($booking->customer?->email ?? '-'); ?></div>
                </td>
                <td class="px-6 py-4">
                ...
                <td class="px-6 py-4">
                    <?php if($booking->petugas): ?>
                        <div class="text-sm text-gray-900"><?php echo e($booking->petugas->name); ?></div>
                    <?php else: ?>
                ...
                <td class="px-6 py-4">
                    ...
                    ?>
                    <span class="px-2 py-1 rounded-full text-xs font-medium <?php echo e($displayClass); ?>">
                        <?php echo e($displayLabel); ?>

                    </span>
                </td>
                <td class="px-6 py-4">
                    <a href="<?php echo e(route('admin.bookings.show', $booking)); ?>" class="text-blue-600 hover:text-blue-900 font-medium text-sm">
                        Detail
                    </a>
                </td>
            </tr>
...
<?php /**PATH D:\Project\laragon\www\risingcare\resources\views/admin/bookings/partials/booking-table.blade.php ENDPATH**/ ?>