...
<div class="mb-6">
    <div class="flex items-center justify-between">
        ...
        <a href="<?php echo e(route('admin.bookings.index')); ?>" class="text-teal-600 hover:text-teal-800 font-medium flex items-center">
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6" x-data="{ showVerifyModal: false, showProofModal: false, proofImage: '' }">
    ...
    <div class="<?php echo e($isFullyPaidAdmin ? 'lg:col-span-3' : 'lg:col-span-2'); ?> space-y-6">
        <!-- Booking Header -->
        <div class="bg-white rounded-xl shadow-sm p-6">
            <div class="flex justify-between items-start mb-6">
                <div>
                    <h2 class="text-lg font-semibold text-gray-800">Booking Information</h2>
                    <p class="text-sm text-gray-500 font-mono"><?php echo e($booking->booking_number); ?></p>
                </div>
                <div>
                    <?php
                        $statusClasses = [
                    ...
                    ?>
                    <span class="px-3 py-1 rounded-full text-sm font-medium <?php echo e($displayClass); ?>">
            ...
            <div class="grid grid-cols-2 gap-6">
                <div>
                    ...
                    <p class="font-medium text-gray-900"><?php echo e($booking->customer->name); ?></p>
                    <p class="text-sm text-gray-600"><?php echo e($booking->customer->email); ?></p>
                ...
                <div>
                    ...
                    <p class="font-medium text-gray-900"><?php echo e(optional($booking->service)->name ?? 'Service Deleted'); ?></p>
                    <p class="text-sm text-gray-600"><?php echo e(optional(optional($booking->service)->category)->name ?? '-'); ?></p>
                </div>
                <div>
            ...
            <?php if($booking->booking_type == 'home_visit' && $booking->customer_address): ?>
            <div class="mt-6 pt-6 border-t">
                <label class="text-sm text-gray-500 block mb-1">Alamat Kunjungan</label>
                <p class="text-gray-900"><?php echo e($booking->customer_address); ?></p>
            </div>
            <?php endif; ?>
            ...
            <div class="mt-6 pt-6 border-t">
                ...
                <p class="text-gray-700 bg-gray-50 p-3 rounded"><?php echo e($booking->customer_notes); ?></p>
            </div>
            <?php endif; ?>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6">
            ...
            <div class="space-y-3">
                ...
                <div class="flex justify-between text-green-600 font-medium">
                    ...
                    <span>Rp <?php echo e(number_format($dpAmount, 0, ',', '.')); ?></span>
                </div>
                <div class="flex justify-between text-gray-800 border-b border-gray-100 pb-2">
                    <span>Sisa Bayar Layanan</span>
                    <span>Rp <?php echo e(number_format($sisaBayarService, 0, ',', '.')); ?></span>
                </div>
                <?php endif; ?>
                ...
                <?php if($booking->bookingAddons && $booking->bookingAddons->count() > 0): ?>
                    <div class="flex justify-between text-gray-800 pt-2">
                        <span>Add-ons</span>
                        <span class="font-medium">Rp <?php echo e(number_format($addonsTotal, 0, ',', '.')); ?></span>
                    </div>
                    <div class="space-y-1">
                ...
                <?php if($booking->payment): ?>
                    <!-- Discounts -->
                    <?php if($booking->payment->membership_discount > 0): ?>
                    <div class="flex justify-between text-green-600 text-sm">
                        <span>Diskon Membership</span>
                        <span>-Rp <?php echo e(number_format($booking->payment->membership_discount, 0, ',', '.')); ?></span>
                    </div>
                    <?php endif; ?>

                    <?php if($booking->payment->voucher_discount > 0): ?>
                    <div class="flex justify-between text-green-600 text-sm">
                        <span>Diskon Voucher</span>
                        <span>-Rp <?php echo e(number_format($booking->payment->voucher_discount, 0, ',', '.')); ?></span>
                    </div>
                    <?php endif; ?>
                    ...
                    <?php if($booking->payment->payment_type == 'dp'): ?>
                        <div class="border-t border-gray-200 pt-3 flex justify-between font-bold text-orange-600 text-lg">
                            ...
                            <span>Rp <?php echo e(number_format($totalKurangBayar, 0, ',', '.')); ?></span>
                        </div>
                        
                        
                        <?php if($booking->payment->final_payment_proof && $booking->payment->status == 'paid'): ?>
                    ...
                    <?php else: ?>
                        ...
                        <div class="border-t border-gray-200 pt-3 flex justify-between font-bold text-gray-900 text-lg">
                            ...
                            <span>Rp <?php echo e(number_format($servicePrice + $addonsTotal - $discounts, 0, ',', '.')); ?></span>
                        </div>
    ...
    <?php if(!$isFullyPaidAdmin && $booking->payment): ?>
    <div class="space-y-6">
        <div class="bg-white rounded-xl shadow-sm p-6">
            ...
            <div class="mb-4">
                ...
                <?php if(optional($booking->payment)->status == 'paid'): ?>
                    <span class="px-3 py-1 bg-green-100 text-green-800 rounded-full text-xs font-bold">LUNAS</span>
                <?php elseif(optional($booking->payment)->status == 'pending_verification'): ?>
                    <span class="px-3 py-1 bg-green-100 text-yellow-800 rounded-full text-xs font-bold">PERLU VERIFIKASI</span>
                <?php elseif(optional($booking->payment)->status == 'failed'): ?>
            ...
            <div class="grid grid-cols-2 gap-3 mb-4">
                <?php if(optional($booking->payment)->payment_proof): ?>
                    <?php if(optional($booking->payment)->payment_type == 'dp'): ?>
                ...
                <?php if(optional($booking->payment)->final_payment_proof): ?>
                <button @click="showProofModal = true; proofImage = '<?php echo e(asset('storage/' . $booking->payment->final_payment_proof)); ?>'" 
            ...
            <?php if(!$isFullyPaidAdmin && $booking->payment && in_array(optional($booking->payment)->status, ['pending', 'pending_verification'])): ?>
            <div class="flex flex-col gap-2">
                <form id="verify-form" action="<?php echo e(route('admin.payments.verify', $booking->payment)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                ...
                <form id="reject-form" action="<?php echo e(route('admin.payments.reject', $booking->payment)); ?>" method="POST" class="hidden mt-2">
                    <?php echo csrf_field(); ?>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6">
            ...
            <?php if($booking->petugas): ?>
                <div class="mb-4">
                    ...
                    <p class="font-medium text-gray-900"><?php echo e($booking->petugas->name); ?></p>
                </div>
            <?php endif; ?>
            
            <form action="<?php echo e(route('admin.bookings.assign-petugas', $booking)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <select name="petugas_id" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 mb-3 disabled:bg-gray-100 disabled:text-gray-500"
                    <?php echo e($booking->status == 'pending_payment' ? 'disabled' : ''); ?>>
                    ...
                    <?php $__currentLoopData = $petugas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($p->id); ?>" <?php echo e($booking->petugas_id == $p->id ? 'selected' : ''); ?>>
                            <?php echo e($p->name); ?>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6">
            ...
            <form action="<?php echo e(route('admin.bookings.update-status', $booking)); ?>" method="POST">
                ...
                <select name="status" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 mb-3">
                    <option value="scheduled" <?php echo e($booking->status == 'scheduled' ? 'selected' : ''); ?>>Terjadwal</option>
                    <?php if($booking->booking_type != 'home_visit'): ?>
                    <option value="checked_in" <?php echo e($booking->status == 'checked_in' ? 'selected' : ''); ?>>Check-in</option>
                    <?php endif; ?>
                    <option value="in_progress" <?php echo e($booking->status == 'in_progress' ? 'selected' : ''); ?>>Diproses</option>
                    <option value="pending_payment" <?php echo e($booking->status == 'pending_payment' ? 'selected' : ''); ?>>Menunggu Pembayaran</option>
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <p class="text-sm text-yellow-700">
                                Mohon periksa mutasi rekening Anda. Pastikan dana sejumlah <span class="font-bold">Rp <?php echo e(number_format($booking->final_price ?? $booking->estimated_price, 0, ',', '.')); ?></span> sudah masuk sebelum memverifikasi.
                            </p>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Project\laragon\www\risingcare\resources\views/admin/bookings/show.blade.php ENDPATH**/ ?>