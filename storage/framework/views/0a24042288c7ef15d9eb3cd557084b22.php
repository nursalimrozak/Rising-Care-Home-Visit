...
<?php $__env->startSection('title', 'Detail Booking - RisingCare'); ?>

<?php $__env->startSection('content'); ?>
<div class="mb-6">
    <div class="flex items-center justify-between">
        <h1 class="text-2xl font-bold text-gray-800">Detail Booking</h1>
        <a href="<?php echo e(route('petugas.bookings')); ?>" class="text-teal-600 hover:text-teal-800 font-medium flex items-center">
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="<?php echo e($isFullyPaid ? 'lg:col-span-3' : 'lg:col-span-2'); ?> space-y-6">
        <!-- Booking Info Card -->
        <div class="bg-white rounded-xl shadow-sm p-6">
            <div class="flex justify-between items-start mb-6">
                <div>
                    ...
                    <p class="text-sm text-gray-500 font-mono">
                        ...
                        <?php if($visitLabel): ?>
                            <span class="text-teal-600"><?php echo e($visitLabel); ?></span>
                        <?php endif; ?>
                    </p>
                </div>
                <div>
                    ...
                    <?php if($showReadyToComplete): ?>
                        <span class="px-3 py-1 rounded-full text-sm font-medium bg-teal-100 text-teal-800">
                            Siap Diselesaikan
                        </span>
                    <?php else: ?>
                        <span class="px-3 py-1 rounded-full text-sm font-medium <?php echo e($statusClasses[$booking->status] ?? 'bg-gray-100 text-gray-800'); ?>">
            ...
            <!-- Timer Display -->
            <?php if($booking->status == 'in_progress' && $booking->started_at): ?>
            <div class="mb-6 p-4 bg-purple-50 border-2 border-purple-200 rounded-lg">
                <div class="flex items-center justify-between">
                    ...
                    <div class="text-right">
                        ...
                        <p class="text-sm font-medium"><?php echo e($booking->started_at->format('H:i')); ?></p>
                    </div>
                </div>
            </div>
            <?php endif; ?>
            ...
            <div class="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg text-center">
                ...
                <p class="text-2xl font-bold text-green-900">
                    <?php if($hours > 0): ?>
                        <?php echo e($hours); ?> jam <?php echo e($minutes); ?> menit
                    <?php else: ?>
                        <?php echo e($minutes); ?> menit
                    <?php endif; ?>
                </p>
            </div>
            <?php endif; ?>
            ...
            <div class="grid grid-cols-2 gap-6">
                <div>
                    ...
                    <a href="<?php echo e(route('petugas.customers.show', $booking->customer->code)); ?>" class="font-medium text-teal-600 hover:text-teal-800 hover:underline">
                        <?php echo e($booking->customer->name); ?>

                    </a>
                    <p class="text-sm text-gray-600"><?php echo e($booking->customer->phone); ?></p>
                </div>
                <div>
                    <label class="text-sm text-gray-500 block mb-1">Layanan</label>
                    <p class="font-medium text-gray-900"><?php echo e($booking->service->name); ?></p>
                    <p class="text-sm text-gray-600">Rp <?php echo e(number_format($booking->estimated_price, 0, ',', '.')); ?></p>
                </div>
                <div>
                    <label class="text-sm text-gray-500 block mb-1">Jadwal</label>
                    <p class="font-medium text-gray-900"><?php echo e(\Carbon\Carbon::parse($booking->scheduled_date)->format('d F Y')); ?></p>
                    <p class="text-sm text-gray-600"><?php echo e(\Carbon\Carbon::parse($booking->scheduled_time)->format('H:i')); ?> WIB</p>
                </div>
                <div>
                    <label class="text-sm text-gray-500 block mb-1">Alamat</label>
                    <p class="text-sm text-gray-900"><?php echo e($booking->customer_address ?? '-'); ?></p>
                </div>
            </div>
            <?php if($booking->customer_notes): ?>
            <div class="mt-4 pt-4 border-t">
                <label class="text-sm text-gray-500 block mb-1">Catatan Customer</label>
                <p class="text-sm text-gray-900 italic">"<?php echo e($booking->customer_notes); ?>"</p>
            </div>
            <?php endif; ?>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6">
                ...
                <div class="space-y-2">
                    <div class="flex justify-between text-sm">
                        <span>
                            <?php if($booking->packagePurchase): ?>
                                Paket <?php echo e($booking->packagePurchase->package->name); ?>

                            <?php else: ?>
                                <?php echo e($booking->service->name ?? 'Layanan Tidak Tersedia'); ?>

                            <?php endif; ?>
                        </span>
                        <span>Rp <?php echo e(number_format($booking->estimated_price, 0, ',', '.')); ?></span>
                    </div>
                    <?php if($booking->bookingAddons->count() > 0): ?>
                    <div class="flex justify-between text-sm">
                        <span>Add-ons</span>
                        <span>Rp <?php echo e(number_format($booking->bookingAddons->sum('subtotal'), 0, ',', '.')); ?></span>
                    </div>
                    <div class="pl-4 text-xs text-gray-500 space-y-1 mt-1 mb-2 border-l-2 border-gray-200 ml-1">
                        ...
                        <div class="flex justify-between">
                            <span><?php echo e($addon->addon->name); ?> (x<?php echo e($addon->quantity); ?>)</span>
                            <span>Rp <?php echo e(number_format($addon->subtotal, 0, ',', '.')); ?></span>
                        </div>
                    ...
                    <?php if($isPackagePaid): ?>
                        ...
                        <div class="pt-2 border-t border-gray-300">
                            <div class="flex justify-between text-sm text-green-600 mb-2">
                                ...
                                <span class="font-medium">Rp <?php echo e(number_format($booking->estimated_price, 0, ',', '.')); ?></span>
                            </div>
                            
                            <?php if($booking->bookingAddons->count() > 0): ?>
                                <div class="flex justify-between text-sm">
                                    <span>Add-ons yang perlu dibayar:</span>
                                    <span class="font-medium">Rp <?php echo e(number_format($totalAmount, 0, ',', '.')); ?></span>
                                </div>
                            <?php else: ?>
                    ...
                    <?php else: ?>
                        ...
                        <div class="pt-2 border-t border-gray-300 flex justify-between font-bold text-base">
                            ...
                            <span class="text-gray-900">Rp <?php echo e(number_format($totalAmount, 0, ',', '.')); ?></span>
                        </div>
                        
                        <?php if($booking->payment): ?>
                        <div class="flex justify-between text-sm text-green-600">
                            <span>Sudah Dibayar (<?php echo e($booking->payment->payment_type == 'dp' ? 'DP' : 'Lunas'); ?>)</span>
                            <span class="font-medium">Rp <?php echo e(number_format($paidAmount, 0, ',', '.')); ?></span>
                        </div>
                        ...
                        <div class="pt-2 border-t border-gray-300 flex justify-between font-bold text-lg">
                            ...
                            <span class="text-orange-600">Rp <?php echo e(number_format($remainingAmount, 0, ',', '.')); ?></span>
                        </div>
            ...
            <?php if(!$booking->payment && (!$isPackagePaid || ($isPackagePaid && $totalAmount > 0))): ?>
            <form action="<?php echo e(route('petugas.bookings.payment', $booking)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="space-y-4">
                    <div>
            ...
            <div class="space-y-3">
                <div class="flex justify-between items-center">
                    ...
                    <span class="font-medium"><?php echo e($booking->payment->payment_method == 'cash' ? 'Cash' : 'Transfer'); ?></span>
                </div>
                
                <div class="flex justify-between items-center gap-3">
                    <span class="text-gray-600">Status:</span>
                    <div class="flex items-center gap-2 flex-wrap justify-end">
                        <?php if($booking->payment->payment_proof): ?>
                            <?php if($booking->payment->payment_type == 'dp'): ?>
                            <span onclick="openImageModal('<?php echo e(asset('storage/' . $booking->payment->payment_proof)); ?>')" 
                            ...
                            <?php elseif($booking->payment->payment_type == 'addon'): ?>
                            <span onclick="openImageModal('<?php echo e(asset('storage/' . $booking->payment->payment_proof)); ?>')" 
                        ...
                        <?php if($booking->payment->final_payment_proof): ?>
                        <span onclick="openImageModal('<?php echo e(asset('storage/' . $booking->payment->final_payment_proof)); ?>')" 
                        ...
                        <?php if($booking->payment->addon_payment_proof): ?>
                        <span onclick="openImageModal('<?php echo e(asset('storage/' . $booking->payment->addon_payment_proof)); ?>')" 
                            class="cursor-pointer px-3 py-1.5 bg-teal-100 text-teal-800 rounded-lg text-xs font-medium hover:bg-teal-200 transition flex items-center gap-1 border border-teal-200">
                            <i class="fas fa-receipt"></i> Bukti Pembayaran Addons
                        </span>
                        <?php endif; ?>
                        
                        <?php if($booking->payment->status == 'paid'): ?>
                            <?php if($booking->payment->payment_type == 'dp' && $remainingAmount > 0): ?>
                        ...
                        <?php if($booking->payment->payment_type == 'dp' && $booking->payment->final_payment_proof && $booking->payment->status == 'paid'): ?>
            ...
            <?php if($booking->bookingAddons->count() > 0 && (!$booking->payment || (!$booking->payment->addon_payment_proof && $booking->payment->payment_type != 'addon'))): ?>
            <div class="mt-4 p-4 bg-teal-50 border border-teal-200 rounded-lg" x-data="{ method: '' }">
                ...
                <p class="text-sm text-teal-700 mb-3">
                    Total Add-ons: <span class="font-bold">Rp <?php echo e(number_format($booking->bookingAddons->sum('subtotal'), 0, ',', '.')); ?></span>
                </p>
                <form action="<?php echo e(route('petugas.bookings.upload-addon-payment', $booking)); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="space-y-3">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="flex items-center gap-3 p-2 bg-gray-50 rounded border border-gray-100">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <p class="font-bold text-gray-800 text-sm truncate"><?php echo e($bank->bank_name); ?></p>
                                        <div class="flex items-center gap-2">
                                            <p class="font-mono text-xs text-gray-600"><?php echo e($bank->account_number); ?></p>
                                            <button type="button" onclick="navigator.clipboard.writeText('<?php echo e($bank->account_number); ?>')" class="text-xs text-teal-600 hover:text-teal-800">
        ...
        <!-- Action Buttons -->
        <?php if($booking->booking_type == 'on_site' && $booking->status == 'scheduled'): ?>
        <div class="bg-white rounded-xl shadow-sm p-6">
            <h3 class="font-semibold text-gray-800 mb-4">Check-in Customer</h3>
            <form action="<?php echo e(route('petugas.bookings.checkin', $booking)); ?>" method="POST">
                <?php echo csrf_field(); ?>
        ...
        <?php if(in_array($booking->status, ['scheduled', 'checked_in'])): ?>
        <div class="bg-white rounded-xl shadow-sm p-6">
            ...
            <?php if(!$canStart): ?>
                <div class="mb-3 p-3 bg-orange-50 border border-orange-200 rounded-lg">
                    <p class="text-sm text-orange-800">
                        <i class="fas fa-exclamation-triangle mr-1"></i> <?php echo e($blockMessage); ?>

                    </p>
                </div>
            <?php endif; ?>
            
            <form action="<?php echo e(route('petugas.bookings.start', $booking)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <button type="submit" 
                    class="w-full px-4 py-2 rounded-lg <?php echo e($canStart ? 'bg-purple-600 hover:bg-purple-700 text-white' : 'bg-gray-300 text-gray-500 cursor-not-allowed'); ?>"
                    <?php echo e(!$canStart ? 'disabled' : ''); ?>>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6">
            ...
            <form action="<?php echo e(route('petugas.bookings.complete', $booking)); ?>" method="POST">
                <?php echo csrf_field(); ?>
        ...
        <?php if($booking->status == 'pending_payment' || ($booking->payment && $booking->status != 'completed')): ?>
        <div class="bg-white rounded-xl shadow-sm p-6">
            ...
            <div class="p-4 bg-<?php echo e($statusColor); ?>-50 text-<?php echo e($statusColor); ?>-800 rounded-lg mb-4 text-sm flex items-center">
                <?php if($statusColor == 'orange'): ?>
                    <i class="fas fa-exclamation-circle mr-2"></i>
                <?php else: ?>
                    <i class="fas fa-check-circle mr-2"></i>
                <?php endif; ?>
                <?php echo e($statusMessage ?: 'Menunggu pembayaran...'); ?>

            </div>

            <form action="<?php echo e(route('petugas.bookings.finalize', $booking)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <button type="submit" 
                    class="w-full px-4 py-2 rounded-lg font-bold text-lg shadow-lg transform transition hover:-translate-y-0.5 <?php echo e($canFinalize ? 'bg-green-600 text-white hover:bg-green-700' : 'bg-gray-300 text-gray-500 cursor-not-allowed'); ?>"
                    <?php echo e(!$canFinalize ? 'disabled' : ''); ?>>
    ...
    <div class="space-y-6">
        <div class="bg-white rounded-xl shadow-sm p-6">
            ...
            <div class="space-y-2 mb-4">
                ...
                <div class="p-3 bg-gray-50 rounded">
                    <div class="flex justify-between items-start mb-1">
                        <span class="text-gray-900 font-medium text-sm"><?php echo e($bookingAddon->addon->name); ?></span>
                        <div class="flex items-center gap-2">
                            <span class="text-xs text-gray-500">x<?php echo e($bookingAddon->quantity); ?></span>
                            
                            <?php if($booking->status == 'pending_payment' || ($booking->payment && $booking->payment->status == 'paid' && $booking->payment->payment_type == 'dp')): ?>
                            <form action="<?php echo e(route('petugas.booking-addons.destroy', $bookingAddon->id)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                    ...
                    <div class="flex justify-between items-center">
                        <span class="text-xs text-gray-500">@ Rp <?php echo e(number_format($bookingAddon->price_per_item, 0, ',', '.')); ?></span>
                        <span class="text-teal-600 font-medium text-sm">Rp <?php echo e(number_format($bookingAddon->subtotal, 0, ',', '.')); ?></span>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <div class="pt-2 border-t">
                    <div class="flex justify-between items-center font-bold text-sm">
                        <span>Total:</span>
                        <span class="text-teal-600">Rp <?php echo e(number_format($booking->bookingAddons->sum('subtotal'), 0, ',', '.')); ?></span>
                    </div>
                </div>
            </div>
            <?php else: ?>
            ...
            <?php if($booking->status == 'pending_payment' || ($booking->payment && $booking->payment->status == 'paid' && $booking->payment->payment_type == 'dp')): ?>
            <form action="<?php echo e(route('petugas.bookings.add-addon', $booking)); ?>" method="POST" id="addonForm">
                <?php echo csrf_field(); ?>
            ...
            <script>
                let addonRowCount = 0;
                const availableAddons = <?php echo json_encode($availableAddons, 15, 512) ?>;
        ...
        <div class="bg-white rounded-xl shadow-sm p-6">
            ...
            <div class="space-y-3 mb-6">
                ...
                <div class="flex items-center gap-3 p-3 bg-gray-50 rounded-lg border border-gray-100">
                    ...
                    <div>
                        <p class="font-bold text-gray-800"><?php echo e($bank->bank_name); ?></p>
                        <div class="flex items-center gap-2">
                            <p class="font-mono text-sm text-gray-600"><?php echo e($bank->account_number); ?></p>
                            <button onclick="navigator.clipboard.writeText('<?php echo e($bank->account_number); ?>')" class="text-xs text-teal-600 hover:text-teal-800">
                                <i class="fas fa-copy"></i>
                            </button>
                        </div>
                        <p class="text-xs text-gray-500">a.n <?php echo e($bank->account_holder); ?></p>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
...
<script>
    ...
    // Timer functionality
    <?php if($booking->status == 'in_progress' && $booking->started_at): ?>
    const startTime = new Date('<?php echo e($booking->started_at->toIso8601String()); ?>').getTime();
...
<?php echo $__env->make('layouts.petugas', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Project\laragon\www\risingcare\resources\views/petugas/bookings/show.blade.php ENDPATH**/ ?>