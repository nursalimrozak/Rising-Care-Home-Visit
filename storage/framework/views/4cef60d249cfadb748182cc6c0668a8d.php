...
<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-blue-100 py-12 px-4">
    <div class="max-w-md w-full bg-white rounded-xl shadow-lg p-8">
        <div class="text-center mb-8">
            ...
            <p class="text-gray-600 mt-2">Selamat datang kembali di <?php echo e($siteName); ?></p>
        </div>
        ...
        <p class="text-center text-gray-600 mt-6">
            Belum punya akun? 
            <a href="<?php echo e(route('registrasi')); ?>" class="text-blue-600 hover:underline font-medium">Daftar sekarang</a>
        </p>
    </div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Project\laragon\www\risingcare\resources\views/auth/login.blade.php ENDPATH**/ ?>