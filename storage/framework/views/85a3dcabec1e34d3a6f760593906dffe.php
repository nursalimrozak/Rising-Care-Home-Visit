...
<?php $__env->startSection('title', 'Manajemen Rekap Kesehatan - RisingCare'); ?>
        ...
        <div class="space-y-4" x-data="{ openCategory: null }">
            ...
            <div class="bg-white rounded-xl shadow-sm overflow-hidden">
                <div class="px-6 py-4 bg-gradient-to-r from-teal-50 to-blue-50 border-b border-gray-200 cursor-pointer hover:bg-gradient-to-r hover:from-teal-100 hover:to-blue-100 transition"
                     @click="openCategory = openCategory === <?php echo e($category->id); ?> ? null : <?php echo e($category->id); ?>">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3 flex-1">
                            <i class="fas fa-folder-open text-teal-600"></i>
                            <div>
                                <h3 class="font-bold text-gray-800"><?php echo e($category->name); ?></h3>
                                <?php if($category->description): ?>
                                    <p class="text-sm text-gray-600 mt-1"><?php echo e($category->description); ?></p>
                                <?php endif; ?>
                            </div>
                        </div>
                        <div class="flex items-center gap-4">
                            <span class="text-sm text-gray-500">(<?php echo e($category->questions->count()); ?> pertanyaan)</span>
                ...
                <div x-show="openCategory === <?php echo e($category->id); ?>" 
                    ...
                    <table class="w-full text-left">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            <?php $__empty_2 = true; $__currentLoopData = $category->questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 text-gray-600"><?php echo e($question->order); ?></td>
                                <td class="px-6 py-4 font-medium text-gray-800"><?php echo e($question->question); ?></td>
                                <td class="px-6 py-4">
                                    <span class="px-2 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                        <?php echo e(ucfirst($question->type)); ?>

                                    </span>
                                </td>
                                <td class="px-6 py-4">
                                    <span class="px-2 py-1 rounded-full text-xs font-medium <?php echo e($question->is_active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                                        <?php echo e($question->is_active ? 'Aktif' : 'Nonaktif'); ?>

                                    </span>
                                </td>
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-2">
                                        <button onclick='openEditModal(<?php echo json_encode($question, 15, 512) ?>)' class="text-blue-600 hover:text-blue-800">
                                            <i class="fas fa-edit"></i>
                                        </button>
                                        <form id="deleteForm<?php echo e($question->id); ?>" action="<?php echo e(route('admin.health-screening.destroy', $question)); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('DELETE'); ?>
                                            <button type="button" onclick="openDeleteModal(<?php echo e($question->id); ?>, '<?php echo e(addslashes($question->question)); ?>')" class="text-red-600 hover:text-red-800">
            ...
            <div class="bg-white rounded-xl shadow-sm overflow-hidden">
                <div class="px-6 py-4 bg-gray-50 border-b border-gray-200 cursor-pointer hover:bg-gray-100 transition"
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center gap-4">
                            <span class="text-sm text-gray-500">(<?php echo e($uncategorized->count()); ?> pertanyaan)</span>
                            <i class="fas fa-chevron-down text-gray-400 transition-transform duration-200"
                ...
                <div x-show="openCategory === 'uncategorized'" 
                    ...
                    <table class="w-full text-left">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            <?php $__currentLoopData = $uncategorized; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 text-gray-600"><?php echo e($question->order); ?></td>
                                <td class="px-6 py-4 font-medium text-gray-800"><?php echo e($question->question); ?></td>
                                <td class="px-6 py-4">
        ...
        <div class="bg-white rounded-xl shadow-sm p-6">
            ...
            <table class="w-full text-left">
                ...
                <tbody class="divide-y divide-gray-100">
                    <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4 text-gray-600"><?php echo e($category->order); ?></td>
                        ...
                        <td class="px-6 py-4 text-center">
                            <span class="px-2 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                <?php echo e($category->questions->count()); ?>

                            </span>
                        </td>
                        <td class="px-6 py-4">
                            <span class="px-2 py-1 rounded-full text-xs font-medium <?php echo e($category->is_active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-2">
                                <button type="button" onclick="openEditCategoryModal(<?php echo e(json_encode($category)); ?>)" class="text-blue-600 hover:text-blue-800">
                                    <i class="fas fa-edit"></i>
                                </button>
                                <form id="deleteCategoryForm<?php echo e($category->id); ?>" action="<?php echo e(route('admin.health-categories.destroy', $category)); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('DELETE'); ?>
                                    <button type="button" onclick="openDeleteCategoryModal(<?php echo e($category->id); ?>, '<?php echo e(addslashes($category->name)); ?>')" class="text-red-600 hover:text-red-800">
                                        <i class="fas fa-trash"></i>
                                    </button>
                                </form>
                            </div>
            ...
            <form id="categoryForm" method="POST" class="p-6">
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <input type="number" name="order" id="categoryOrder" value="<?php echo e($nextCategoryOrder); ?>" min="1" required
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500">
                    </div>
...
<div x-show="showQuestionForm" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" style="display: none;">
    <div class="bg-white rounded-xl shadow-lg w-full max-w-lg mx-4 overflow-hidden">
        ...
        <form action="<?php echo e(route('admin.health-screening.store')); ?>" method="POST" class="p-6">
            <?php echo csrf_field(); ?>
            <div class="mb-4">
                ...
                <select name="category_id" id="addCategorySelect" onchange="updateOrderBasedOnCategory()"
                    ...
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($category->id); ?>" data-next-order="<?php echo e($nextOrderByCategory[$category->id] ?? 1); ?>"><?php echo e($category->name); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
                <label class="block text-gray-700 font-medium mb-2">Urutan</label>
                <input type="number" name="order" id="addOrderInput" value="<?php echo e($nextOrderUncategorized); ?>" min="1" required
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500">
            </div>
            <div class="flex justify-end gap-3 mt-6">
...
<script>
    ...
    window.closeAddQuestionModal = function() {
        ...
        if (form) {
            ...
            document.getElementById('addOrderInput').value = <?php echo e($nextOrderUncategorized); ?>;
            // Hide options field
    ...
    function updateOrderBasedOnCategory() {
        ...
        if (selectedOption.value === '') {
            // Tanpa kategori
            orderInput.value = <?php echo e($nextOrderUncategorized); ?>;
        } else {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (categoryForm) {
            categoryForm.addEventListener('submit', function(e) {
                ...
                if (method === 'POST') {
                    categoryForm.action = '<?php echo e(route("admin.health-categories.store")); ?>';
                }
            });
        }
    });
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Project\laragon\www\risingcare\resources\views/admin/health-screening/index.blade.php ENDPATH**/ ?>