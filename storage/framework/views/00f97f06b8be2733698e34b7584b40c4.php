...
<?php $__env->startSection('title', 'Dashboard Petugas - RisingCare'); ?>
    ...
    <div class="bg-white rounded-xl shadow-sm p-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-2xl font-bold text-gray-900"><?php echo e($todayBookings); ?></p>
            </div>
    ...
    <div class="bg-white rounded-xl shadow-sm p-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-2xl font-bold text-gray-900"><?php echo e($activeBookings); ?></p>
            </div>
    ...
    <div class="bg-white rounded-xl shadow-sm p-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-2xl font-bold text-gray-900"><?php echo e($completedBookings); ?></p>
            </div>
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50">
                    <td class="px-6 py-4 font-mono text-sm">
                        ...
                        <?php if($visitLabel): ?>
                            <span class="text-xs text-teal-600 ml-1"><?php echo e($visitLabel); ?></span>
                        <?php endif; ?>
                    </td>
                    <td class="px-6 py-4">
                        <?php if($booking->customer): ?>
                            <div class="font-medium text-gray-900"><?php echo e($booking->customer->name); ?></div>
                            <div class="text-xs text-gray-500"><?php echo e($booking->customer->phone); ?></div>
                        <?php else: ?>
                    ...
                    <td class="px-6 py-4 text-gray-900">
                        <?php if($booking->service): ?>
                            ...
                            <?php if($booking->packagePurchase && $booking->packagePurchase->package): ?>
                                <span class="text-teal-600"> - <?php echo e($booking->packagePurchase->package->name); ?></span>
                            <?php endif; ?>
                        <?php else: ?>
                    ...
                    <td class="px-6 py-4">
                        <div class="text-gray-900"><?php echo e(\Carbon\Carbon::parse($booking->scheduled_date)->format('d M Y')); ?></div>
                    ...
                    <td class="px-6 py-4">
                        ...
                        ?>
                        <span class="px-2 py-1 rounded-full text-xs font-medium <?php echo e($statusClasses[$booking->status] ?? 'bg-gray-100 text-gray-800'); ?>">
...
<?php echo $__env->make('layouts.petugas', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Project\laragon\www\risingcare\resources\views/petugas/dashboard.blade.php ENDPATH**/ ?>