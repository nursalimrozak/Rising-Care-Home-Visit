...
<?php $__env->startSection('title', 'Manajemen Layanan - RisingCare'); ?>
...
<div class="mb-6 flex justify-between items-center">
    ...
    <div class="flex gap-2">
        <a href="<?php echo e(route('admin.service-categories.index')); ?>" class="bg-white text-gray-700 border border-gray-300 px-4 py-2 rounded-lg hover:bg-gray-50 transition">
            <i class="fas fa-tags mr-2"></i> Kategori
        </a>
        <a href="<?php echo e(route('admin.services.create')); ?>" class="bg-teal-600 text-white px-4 py-2 rounded-lg hover:bg-teal-700 transition">
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50">
                    <td class="px-6 py-4">
                        ...
                        <div class="text-xs text-gray-500"><?php echo e(Str::limit($service->description, 50)); ?></div>
                    </td>
                    <td class="px-6 py-4">
                    ...
                    <td class="px-6 py-4 text-sm text-gray-600">
                        <?php echo e($service->duration_minutes); ?> Menit
                    </td>
                    ...
                    <td class="px-6 py-4">
                        <span class="px-2 py-1 text-xs font-medium <?php echo e($service->is_active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?> rounded-full">
                            <?php echo e($service->is_active ? 'Aktif' : 'Non-aktif'); ?>

                        </span>
                    </td>
                    <td class="px-6 py-4 text-sm font-medium">
                        <div class="flex space-x-3">
                            <button type="button" onclick="openEditModal(<?php echo e($service->id); ?>)" class="text-blue-600 hover:text-blue-900"><i class="fas fa-edit"></i></button>
                            <form id="deleteForm<?php echo e($service->id); ?>" action="<?php echo e(route('admin.services.destroy', $service)); ?>" method="POST" class="inline">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('DELETE'); ?>
                                <button type="button" onclick="openDeleteModal('deleteForm<?php echo e($service->id); ?>', '<?php echo e(addslashes($service->name)); ?>')" class="text-red-600 hover:text-red-900"><i class="fas fa-trash"></i></button>
                            </form>
                        </div>
                    </td>
                </tr>
                                ...
                                <?php $__currentLoopData = $memberships ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $membership): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="mb-3">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="number" name="prices[<?php echo e($membership->id); ?>]" 
                                                id="edit_price_<?php echo e($membership->id); ?>"
                                                min="0"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Project\laragon\www\risingcare\resources\views/admin/services/index.blade.php ENDPATH**/ ?>